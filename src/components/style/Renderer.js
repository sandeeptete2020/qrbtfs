...
let builtinDrawIcon = function ({ qrcode, params, title, icon }) {
    ...
    if (icon) {
        ...
        const WeChatIconSmall = (
            <g><path style="opacity:0.974" fill="#fdfefe" d="M 70.5,2.5 C 57.1638,39.171 43.8305,75.8377 30.5,112.5C 7.76255,97.6706 -1.40412,76.6706 3,49.5C 9.16667,24.6667 24.6667,9.16667 49.5,3C 56.4921,2.50038 63.4921,2.33371 70.5,2.5 Z"/></g>
